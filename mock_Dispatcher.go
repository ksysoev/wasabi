...
func (_m *MockDispatcher) Dispatch(conn Connection, data []byte) {
	_m.Called(conn, data)
}
...
func (_c *MockDispatcher_Dispatch_Call) Run(run func(conn Connection, data []byte)) *MockDispatcher_Dispatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Connection), args[1].([]byte))
	})
	return _c
}
...
func (_c *MockDispatcher_Dispatch_Call) RunAndReturn(run func(Connection, []byte)) *MockDispatcher_Dispatch_Call {
	_c.Call.Return(run)
	return _c
}
